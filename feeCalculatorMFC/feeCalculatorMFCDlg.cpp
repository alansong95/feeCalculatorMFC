...
// feeCalculatorMFCDlg.cpp : implementation file
//

#include "stdafx.h"
#include "feeCalculatorMFC.h"
...
CfeeCalculatorMFCDlg::CfeeCalculatorMFCDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CfeeCalculatorMFCDlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CfeeCalculatorMFCDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CfeeCalculatorMFCDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
// CfeeCalculatorMFCDlg message handlers

BOOL CfeeCalculatorMFCDlg::OnInitDialog()
{
...
void CfeeCalculatorMFCDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CfeeCalculatorMFCDlg::OnPaint()
{
	if (IsIconic())
	{
...
HCURSOR CfeeCalculatorMFCDlg::OnQueryDragIcon()
{
